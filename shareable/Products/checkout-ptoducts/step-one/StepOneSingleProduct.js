    ...
    <div className={"checkoutstep__single__product"}>
      <div className={"checkoutstep__single__product__left"}>
        ...
        <div className={"checkoutstep__single__product__left__text"}>
          <h3 className={"checkoutstep__single__product__left__text--name"}>
            Ylumi
          </h3>
          <p className={"checkoutstep__single__product__left__text--type"}>
            Energy
          </p>
          <p className={"checkoutstep__single__product__left__text--quantity"}>
            1 packung
          </p>
          <h3 className={"checkoutstep__single__product__left__text--price"}>
            $ 28.00
          </h3>
