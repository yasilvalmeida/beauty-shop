    ...
    <div className={"checkout__single__product"}>
      <div className={"checkout__single__product__left"}>
        ...
        <div className={"checkout__single__product__left__text"}>
          <h3 className={"checkout__single__product__left__text--name"}>
            Ylumi
          </h3>
          <p className={"checkout__single__product__left__text--type"}>
            Energy
          </p>
          <p className={"checkout__single__product__left__text--quantity"}>
            1 packung
          </p>
          <h3 className={"checkout__single__product__left__text--price"}>
            $ 28.00
          </h3>
      ...
      <div className={"checkout__single__product__right"}>
        <div className={"checkout__single__product__right__top"}>
          ...
          <div className={"checkout__single__product__right__top__quantity"}>
            ...
            <div
              className={
                "checkout__single__product__right__top__quantity__btns"
              }
            >
        ...
        <div className={"checkout__single__product__right__whishlist"}>
          <svg
            onClick={() =>
              router.push(isAuthenticated ? "/konto/whishlist" : "/login")
            }
