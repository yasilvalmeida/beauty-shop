...
const MagazinProductsWhite = ({ elem }) => {
  ...
  return (
    <div
      className={"magazin__single__item__body__white"}
      onMouseOver={() => {
        setRotate("rotated");
    ...
    >
      ...
      <div className={"magazin__single__item__body__white__text"}>
        ...
        <div
          className={`magazin__single__item__body__white__text__hover ${transformed}`}
        >
          <h6
            className={"magazin__single__item__body__white__text__hover--name"}
          >
            {name}
          </h6>
          <p
            className={"magazin__single__item__body__white__text__hover--type"}
          >
            {elem.brand}
          </p>
          <p
            className={"magazin__single__item__body__white__text__hover--type2"}
          >
          ...
          <p
            className={"magazin__single__item__body__white__text__hover--price"}
          >
            {formatter.format(
              variants_of_a_products?.length > 0
          ...
          <button
            className={
              "magazin__single__item__body__white__text__hover--button"
            }
            onClick={() => {
              if (isAuthenticated) {
