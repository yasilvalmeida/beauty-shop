...
const RegistrationForm = ({ textData }) => {
  ...
  useEffect(() => {
    if (!success?.response) {
      if (
        success?.response?.data?.message[0]?.messages[0]?.message !==
          undefined &&
  ...
  return (
    <div className={"registration__form__container"}>
      ...
      >
        <Tooltip
          title={textData?.tooltip_firstname || "Name is required"}
          color={"red"}
        ...
        >
          <input
            name={"name"}
            type="text"
            placeholder={textData?.placeholder_firstname || "Vorname*"}
        ...
        <Tooltip
          title={textData?.tooltip_surname || "Surname is required"}
          color={"red"}
        ...
        >
          <input
            name={"surname"}
            type="text"
            placeholder={textData?.placeholder_surname || "Nachname*"}
        ...
        <Tooltip
          title={textData?.tooltip_email || "Please enter email"}
          color={"red"}
        ...
        >
          <input
            name={"email"}
            type="email"
            placeholder={textData?.placeholder_email || "E-Mail-Adresse*"}
        ...
        <Tooltip
          title={textData?.tooltip_password || "Please enter password"}
          color={"red"}
        ...
        >
          <input
            name={"password"}
            type="password"
            placeholder={textData?.placeholder_password || "Passwort*"}
        ...
        <Tooltip
          title={textData?.tooltip_repeat_password || "Please repeat password"}
          color={"red"}
        ...
        >
          <input
            ...
            placeholder={
              textData?.placeholder_repeat_password || "Passwort bestätigen*"
            }
            onChange={handleValidation}
          />
        </Tooltip>
        ...
        <div className={"registration__form__container__form__newsletter"}>
          <p>{textData?.gender_text || "Geschlecht"}</p>
          <div
            className={"registration__form__container__form__newsletter__item"}
          >
            <div
              className={
            ...
            >
              ...
              />
              <label htmlFor="male">
                {textData?.gender_female || "Männlich"}
              </label>
            </div>
          </div>
        </div>
        <div className={"registration__form__container__form__newsletter"}>
          ...
          >
            ...
            >
              ...
              />
              <label htmlFor="yes">
                {textData?.newsletter_yes || "Ja, bitte!"}
              </label>
            </div>
            <div
              className={
            ...
            >
              ...
              />
              <label htmlFor="no">
                {textData?.newsletter_no || "Nein, danke."}
              </label>
            </div>
          </div>
          <p>
            {textData?.data_protection_text ||
              "Mehr zu unseren E-Mails und Datenschutzbestimmungen."}
          </p>
        </div>
        <Tooltip
          title={textData?.tooltip_robot || "Select if you are not a robot"}
          color={"red"}
        ...
        >
          ...
          >
            ...
            />
            <label htmlFor="yes">
              {textData?.robot || "Ich bin kein Roboter"}
            </label>
          </div>
        </Tooltip>
        <input
          type="submit"
          value={textData?.submit || "Anmelden"}
          className={"registration__form__container__form__submit"}
        />
        <p className={"registration__form__container__form__bottxt"}>
          {textData?.submit_text ||
            "Mit Ihrer Registrierung stimmen Sie den Nutzungsbedingungen von Das Parfum & Beauty zu."}
        </p>
      </form>
    </div>
  );
