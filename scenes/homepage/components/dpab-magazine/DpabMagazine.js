          ...
          <div className={"dpab-magazin-body"}>
            ...
            <div className={"dpab-top-section"}>
              <div className={"dpab-top-section-img"}>
                <Image
                  src={`${dpabBig?.images?.url || "/productbotleft.png"}`}
                  width={1720}
                  height={695}
                  layout="responsive"
                />
              ...
              <div className={"dpab-top-section-txt"}>
                <h2>{dpabBig?.title}</h2>
                <p>{dpabBig?.header}</p>
                <span>{dpabBig?.text}</span>
                <Link href={magazineUrl}>
                  <a href={magazineUrl}>{dpabBig?.link_text}</a>
                </Link>
              </div>
            </div>
            <div className={"dpab-bottom-section d-flex flex-wrap"}>
              <div className={"col-lg-6 dpab-bottom-section-left d-flex"}>
                <div className={"dpab-bottom-section-left-img-bod"}>
                  <div className={"dpab-bottom-section-left-img"}>
                    <Image
                      src={`${dpabLeft?.images?.url || "/productbotleft.png"}`}
                      width={837}
                      height={635}
                      layout="responsive"
                    />
                ...
                <div className={"dpab-bottom-section-left-txt"}>
                  ...
                  <p>{dpabLeft?.header}</p>
                  <span>{dpabLeft?.text}</span>
                  <Link href={magazineUrl}>
                    <a href={magazineUrl}>{dpabLeft?.link_text}</a>
                  </Link>
                </div>
              </div>
              <div className={"dpab-bottom-section-right"}>
                ...
                <span>{dpabRight?.text}</span>
                <div className={"dpab-bottom-section-right-img"}>
                  <Image
                    src={`${dpabRight?.images.url || "/productbotleft.png"}`}
                    width={760}
                    height={627}
                    layout="responsive"
                  />
                ...
                <Link href={magazineUrl}>
                  <a href={magazineUrl}>{dpabRight?.link_text}</a>
                </Link>
              </div>
            </div>
          </div>
